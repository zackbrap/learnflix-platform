...
const InfographicViewer = ({ content, onBack }: InfographicViewerProps) => {
  const { user } = useAuth();
      ...
      <div className="flex flex-col lg:flex-row gap-5">
        ...
        <div className="flex-1 min-w-0">
          {content.url ? (
            <div
              ...
              style={{ borderColor: "#2a2a2a", maxHeight: "calc(100vh - 200px)" }}
            >
              <img
                ref={imgRef}
                src={content.url}
        ...
        >
          ...
          <p className="text-xs text-muted-foreground">
            Observe o infográfico e registre seus insights e pontos-chave.
          </p>
          <Textarea
            value={note}
